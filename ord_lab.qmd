...
-   Convert the outcome variable to an ordered factor. What does the order here represent?
    ...
    The model is ordered from 1st -3. You could also reverse this with ftc_rev. We can interpret this as postive slope = higher prob of being in 2-3rd place.
